...
describe("Firestore security rules", () => {
  ...
  beforeEach(async () => {
    ...
    // Allowlist removed; isolation relies on canAccessChild. Seed Jake→c1 for link-based tests.
  ...
  it("denies reads to authenticated users without canAccessChild access", async () => {
    // Signed-in stranger: user doc doesn't list c1 and they didn't create it.
