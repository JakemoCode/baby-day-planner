...
describe("NextEventCard", () => {
  it("renders the next event label, time and 'in N min' delta", () => {
    ...
    expect(screen.getByText("Start putting down for Nap 2")).toBeInTheDocument();
    expect(screen.getByText("9:30 AM")).toBeInTheDocument();
    expect(screen.getByText(/in 12 min/i)).toBeInTheDocument();
  });
  ...
  it("formats delta over 60 minutes as '1h 5m'", () => {
    ...
    expect(screen.getByText(/in 1h 5m/i)).toBeInTheDocument();
  });
